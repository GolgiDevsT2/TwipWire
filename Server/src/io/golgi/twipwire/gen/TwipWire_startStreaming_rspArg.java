...
public class TwipWire_startStreaming_rspArg
{
    ...
    public TwipWire_startStreaming_rspArg(){
        this(true);
    }

    public TwipWire_startStreaming_rspArg(boolean isSetDefault){
        super();
    ...
    public TwipWire_startStreaming_rspArg(GolgiPayload payload){
        this(false);
        deserialise(payload);
    }

    public TwipWire_startStreaming_rspArg(String payload){
