...
public class TwipWire_newTweet_rspArg
{
    ...
    public TwipWire_newTweet_rspArg(){
        this(true);
    }

    public TwipWire_newTweet_rspArg(boolean isSetDefault){
        super();
    ...
    public TwipWire_newTweet_rspArg(GolgiPayload payload){
        this(false);
        deserialise(payload);
    }

    public TwipWire_newTweet_rspArg(String payload){
